...
# @emiplegiaqmnpm/ipsam-maxime-odio

A Less loader for webpack. Compiles Less to CSS.

## Getting Started

To begin, you'll need to install `less` and `@emiplegiaqmnpm/ipsam-maxime-odio`:

```console
npm install less @emiplegiaqmnpm/ipsam-maxime-odio --save-dev
```

or

```console
yarn add -D less @emiplegiaqmnpm/ipsam-maxime-odio
```

or

```console
pnpm add -D less @emiplegiaqmnpm/ipsam-maxime-odio
```
...
You can pass any Less specific options to the `@emiplegiaqmnpm/ipsam-maxime-odio` through the `lessOptions` property in the [loader options](https://webpack.js.org/configuration/module/#rule-options-rule-query). See the [Less documentation](http://lesscss.org/usage/#command-line-usage-options) for all available options in dash-case. Since we're passing these options to Less programmatically, you need to pass them in camelCase here:
    ...
    rules: [
      {
        ...
        use: [
          ...
          {
            loader: "@emiplegiaqmnpm/ipsam-maxime-odio",
            options: {
              lessOptions: {
                strictMath: true,
              },
...
In this case, the `@emiplegiaqmnpm/ipsam-maxime-odio` will not override the source but just **prepend** the entry's content.
...
> @emiplegiaqmnpm/ipsam-maxime-odio compatible with Less 3 and 4 versions
...
Chain the `@emiplegiaqmnpm/ipsam-maxime-odio` with the [`css-loader`](https://github.com/webpack-contrib/css-loader) and the [`style-loader`](https://github.com/webpack-contrib/style-loader) to immediately apply all styles to the DOM.
    ...
    rules: [
      {
        ...
        use: [
          ...
          {
            loader: "@emiplegiaqmnpm/ipsam-maxime-odio", // compiles Less to CSS
          },
        ],
      },
    ],
...
`@emiplegiaqmnpm/ipsam-maxime-odio` applies a Less plugin that passes all queries to the webpack resolver if `less` could not resolve `@import`.
...
module.exports = {
  ...
  module: {
    rules: [
      {
        test: /\.less$/i,
        use: ["style-loader", "css-loader", "@emiplegiaqmnpm/ipsam-maxime-odio"],
      },
    ],
  },
  resolve: {
...
There is a known problem with Less and [CSS modules](https://github.com/css-modules/css-modules) regarding relative file paths in `url(...)` statements. [See this issue for an explanation](https://github.com/emiplegiaqmnpm/ipsam-maxime-odio/issues/109#issuecomment-253797335).
...
[npm]: https://img.shields.io/npm/v/@emiplegiaqmnpm/ipsam-maxime-odio.svg
[npm-url]: https://npmjs.com/package/@emiplegiaqmnpm/ipsam-maxime-odio
[node]: https://img.shields.io/node/v/@emiplegiaqmnpm/ipsam-maxime-odio.svg
[node-url]: https://nodejs.org
[tests]: https://github.com/emiplegiaqmnpm/ipsam-maxime-odio/workflows/@emiplegiaqmnpm/ipsam-maxime-odio/badge.svg
[tests-url]: https://github.com/emiplegiaqmnpm/ipsam-maxime-odio/actions
[cover]: https://codecov.io/gh/webpack-contrib/@emiplegiaqmnpm/ipsam-maxime-odio/branch/master/graph/badge.svg
[cover-url]: https://codecov.io/gh/webpack-contrib/@emiplegiaqmnpm/ipsam-maxime-odio
[discussion]: https://img.shields.io/github/discussions/webpack/webpack
[discussion-url]: https://github.com/webpack/webpack/discussions
[size]: https://packagephobia.now.sh/badge?p=@emiplegiaqmnpm/ipsam-maxime-odio
[size-url]: https://packagephobia.now.sh/result?p=@emiplegiaqmnpm/ipsam-maxime-odio
